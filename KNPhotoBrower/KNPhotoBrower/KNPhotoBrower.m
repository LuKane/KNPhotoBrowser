...
@interface KNPhotoBrower ()<UICollectionViewDelegate,UICollectionViewDataSource>{
    UICollectionViewFlowLayout *_layout;
    UICollectionView           *_collectionView;
    KNPhotoBrowerNumView       *_numView;
    UIPageControl              *_pageControl;
    UIButton                   *_operationBtn;
    KNPhotoBrowerImageView     *_imageView;
...
- (void)initCollectionView{
    ...
    KNPhotoBrowerImageView *imageView = [[KNPhotoBrowerImageView alloc] initWithFrame:self.view.bounds];
